    ...
    <div class="form-group row">
        ...
        <div class="col-8">
            <div class="input-group">
                ...
                <input id="cognoms" name="cognoms" placeholder="Escriu els teus cognoms" type="text" class="form-control">
            </div>
        </div>
    </div>
    <?php printErrors($errors, 'cognom') ?>
    <div class="form-group row">
        ...
        <div class="col-8">
            <div class="input-group">
                ...
                foreach ($menus as $key => $value) {?>
                    <div class="form-check">
                        <input type="checkbox" name="menus[]" value="<?= $value ?>" id="<?= $key ?>">
